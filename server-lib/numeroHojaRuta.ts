 ...
 * correlativo con las que veníamos haciendo hasta ahora con el panel de IM"*. La última hoja del
 * panel era la 3399 y la próxima iba a salir 3400, pero en IM ya habían usado dos números más.
 *
 ...
 */
export const NUMERO_MINIMO_HOJA = Number(process.env.HOJA_RUTA_NUMERO_MINIMO) || 3402;
